...
IF NOT EXIST %MINICONDA_INSTALL_FOLDER% (
	...
	powershell -Command "Invoke-WebRequest https://repo.anaconda.com/miniconda/Miniconda3-latest-Windows-x86.exe -OutFile %MINICONDA_DOWNLOAD_FOLDER%\%MINICONDA_SETUP_FILENAME%"
